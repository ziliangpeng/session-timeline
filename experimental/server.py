#!/usr/bin/env python3
"""EXPERIMENTAL PROTOTYPE — live web UI for session timelines (standalone copy).

Run:  python experimental/server.py   →  http://127.0.0.1:8766
Everything in experimental/ is a prototype playground; real session data may be
processed locally but NEVER committed (see AGENTS.md HARD RULE #1).
...
GAP_CAP_S = 300.0  # silence longer than this between events is idle, not inference
